...
const projects = [
  {
    ...
    github: "https://github.com/rishav00roy-web/tea-country-holidays",
    live: "https://tea-country-holidays.vercel.app",
    images: [
  ...
  },
  {
    ...
    github: "https://github.com/rishav00roy-web/Gym-CRM",
    live: "https://github.com/rishav00roy-web/Gym-CRM",
    images: [
  ...
  },
  {
    ...
    github: "https://github.com/rishav00roy-web/ClashVault",
    live: "https://byrishav.online",
    images: [
  ...
  return (
    <div className="relative w-screen h-full flex items-center justify-center px-4 sm:px-12 xl:px-24 shrink-0">
      <div className="w-full max-w-7xl relative h-[75vh] sm:h-[80vh] rounded-[2.5rem] overflow-hidden shadow-2xl bg-[#0a0a0a]/90 border border-white/5 flex flex-col lg:flex-row items-center p-8 sm:p-12 xl:p-16 gap-8 lg:gap-12">
        ...
        {/* Glassmorphism Working Button Links */}
        <div className="absolute bottom-6 right-6 sm:bottom-10 sm:right-10 flex flex-col sm:flex-row gap-3 z-20">
          <a
            href={project.github}
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 px-5 py-3 sm:px-6 sm:py-3.5 rounded-full border border-white/20 bg-white/5 backdrop-blur-xl text-white text-xs sm:text-sm font-medium hover:bg-white/10 hover:border-white/40 transition-all shadow-xl"
          >
            <GithubIcon className="w-4 h-4 sm:w-5 sm:h-5 text-[#2EA44F] group-hover:scale-110 transition-transform" />
