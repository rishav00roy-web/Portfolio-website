  ...
  const certificates = [
    {
      ...
      pdf: "/certificates/Coursera-Certificate-1.pdf",
      image: "/certificates/Coursera-Certificate-1.png",
    },
    {
      id: 2,
      title: "Maximize Productivity With AI Tools",
      pdf: "/certificates/Coursera-Certificate-2.pdf",
      image: "/certificates/Coursera-Certificate-2.png",
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8">
          {certificates.map((cert, index) => (
            <motion.div
              ...
              className="relative"
            >
              <div className="relative h-[250px] sm:h-[400px] lg:h-[450px] rounded-xl overflow-hidden border border-white/10 bg-white/[0.02] flex flex-col group">
                <div className="h-10 bg-black/40 border-b border-white/10 flex items-center px-4 font-mono text-xs text-white/50 tracking-wider uppercase z-20 relative">
                  {cert.title}
                </div>
                <div className="flex-1 w-full relative flex items-center justify-center p-0">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <div className="px-6 py-2.5 rounded-full bg-white/10 border border-white/20 text-white text-sm font-medium backdrop-blur-md flex items-center gap-2">
